...
from reamo.dataset.base_dataset import DataCollatorForSupervisedDataset
from reamo.dataset.concat_dataset import MyConcatDataset
from training_utils import ModelArguments, DataArguments, TrainingArguments
from reamo import conversation as conversation_lib
from reamo_trainer import ReamoTrainer
...
def find_all_linear_names(model):
    ...
    multimodal_keywords = ['mm_input_projector']
...
def safe_save_model_for_hf_trainer(trainer: transformers.Trainer,
    ...
    if getattr(trainer.args, 'tune_mm_input_adapter', False):
        ...
        save_flag = safe_save_input_adapter_for_hf_trainer(trainer, output_dir, keys_to_match, 'mm_input_projector.bin')
...
def train(attn_implementation=None):
    ...
    data_module = make_supervised_data_module(tokenizer=tokenizer,
                                              data_args=data_args)
    trainer = ReamoTrainer(model=model,
                    tokenizer=tokenizer,
                    args=training_args,
                    **data_module)
